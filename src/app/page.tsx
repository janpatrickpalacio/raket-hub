...
export default function Home() {
  return (
    <main className='mx-auto [&>section]:px-4'>
      <section className='flex flex-col items-center justify-center gap-2 bg-gradient-to-r from-blue-700 to-cyan-200 to-80% py-28 text-center text-white'>
        <h1 className='text-6xl font-bold'>Gawa na &apos;yan!</h1>
        <p className='text-lg text-white/80'>Find trusted Filipino talent for any project, big or small.</p>
        <div className='mt-8 flex w-full flex-col items-center justify-center gap-4 sm:flex-row'>
          <Input
            className='w-full rounded-full bg-white px-4 py-6 text-black sm:max-w-[480px]'
      ...
      <section>
        <div className='container mx-auto flex flex-col items-center justify-center gap-2 py-28'>
          ...
          <p className='text-lg opacity-80'>Find the right professional for your needs.</p>
      ...
      <section className='flex justify-center'>
        <div className='container flex flex-col items-center justify-center gap-2 py-20'>
          <h2 className='text-3xl font-bold'>Getting Things Done is Easy</h2>
          <p>In just a few simple steps.</p>
      ...
      <section className='flex justify-center bg-neutral-50'>
        <div className='container flex flex-col items-center justify-center gap-2 py-20'>
          <h2 className='text-3xl font-bold'>Meet Our Top Raketeros</h2>
      ...
      <section className='flex justify-center bg-gradient-to-r from-yellow-200 to-orange-500'>
        <div className='container flex flex-col items-center py-20 text-white'>
          ...
          <p className='mt-2 max-w-[512px] text-center text-white/80'>
            Join our community of clients and talented Raketeros today. Your next project is just a few clicks away.
          </p>
          <div className='mt-8 flex items-center gap-4'>
            <Link
              href='#'
              className='rounded-full bg-white px-8 py-3 text-lg font-bold text-black transition-all hover:scale-105 hover:bg-white/80'
            >
              Find a Service
            </Link>
            <Link
              href='#'
              className='rounded-full bg-yellow-300 px-8 py-3 text-lg font-bold text-black transition-all hover:scale-105 hover:bg-yellow-400'
            >
              Become a Raketero
            </Link>
          </div>
