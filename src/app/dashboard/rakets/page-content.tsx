            ...
            <Table>
              ...
              <TableBody>
                {services && services.length > 0 ? (
                  services.map(service => <RaketRow key={service.id} service={service} />)
                ) : (
                  <TableRow>
...
function RaketRow({ service }: { service: RaketsTableRow }) {
  ...
  return (
    <TableRow key={service.id} className='hover:bg-transparent'>
      ...
      <TableCell>
        <CustomBadge variant={getStatusVariant(service.status)} className='rounded-full font-semibold capitalize'>
          {service.status}
        </CustomBadge>
      </TableCell>
            ...
            <DialogContent className='overflow-hidden p-0'>
              <div className='p-4'>
                ...
                <p className='text-sm text-neutral-600'>
                  An administrator has reviewed your Raket and it requires changes before it can be approved. Please see
                  the reason below:
                </p>
